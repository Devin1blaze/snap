<?php
/**
 * WooCommerce Category Template: Optimized Washroom Automations PLP
 */
...
<!-- Card 2 (Row 1) -->
<article class="product-card bg-white border border-outline-variant/30 flex flex-col cursor-pointer relative group">
