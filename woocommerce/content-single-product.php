...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class( 'grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24', $product ); ?>>
    ...
    <div class="product-gallery-wrapper bg-white p-8 relative shadow-2xl border-t-4 border-[#1A56DB]">
        <?php
        /**
...
<div class="product-extended-info border-t border-zinc-800 pt-16">
    <?php
    /**
