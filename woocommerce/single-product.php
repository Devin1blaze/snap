                ...
                <div class="space-y-4">
                    <?php if ( $is_b2b ) : ?>
                        ...
                        <div class="pt-2 space-y-4">
                            <a href="https://wa.me/919876543210" target="_blank" class="group flex items-center justify-between w-full bg-zinc-900 text-white pl-6 pr-2 h-[64px] hover:bg-black transition-all duration-300">
                                <div class="flex items-center gap-3">
                                    <div class="w-2 h-2 bg-[#25D366] animate-pulse"></div>
                                    <span class="text-[11px] font-black uppercase tracking-[0.15em] text-zinc-300 group-hover:text-white transition-colors">WhatsApp Desk Live</span>
                                </div>
                            ...
                            ?>
                            <a href="<?php echo esc_url( $brochure_url ); ?>" target="_blank" class="flex items-center justify-center gap-3 w-full border-4 border-black text-black font-black h-[64px] uppercase tracking-tighter text-lg hover:bg-black hover:text-white transition-all">
