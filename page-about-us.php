...
<span class="relative inline-block">
                Built on Quality.
                <span class="absolute bottom-2 left-0 h-4 bg-[#FBBF24] -z-10 animate-underline"></span>
</span>
</h1>
...
<div class="absolute right-[-10%] bottom-[-10%] w-[500px] h-[500px] bg-[#FBBF24] opacity-10 rounded-full blur-[100px]"></div>
</section>

<!-- Our Story Section -->
<section class="py-24 px-8 md:px-24 bg-white grid md:grid-cols-2 gap-16 items-center">
<div class="border-l-[12px] border-[#FBBF24] pl-10 py-4 cursor-pointer">
...
<div class="relative">
<div class="absolute -top-4 -left-4 w-12 h-12 bg-[#FBBF24] z-20"></div>
<div class="border-[12px] border-primary-container p-4">
<img alt="Our Professional Team" class="w-full h-[500px] object-cover grayscale hover:grayscale-0 transition-all duration-500" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCdlsb-hkYXrFUm4_xsRw0w73lEBa1rGXs5Z-d_XQmF_m5JDWoy_U5lE1Akf6PH1hK9TWVTfBxFVnCrsM1KBrUSn4ISA9cbkWP6lAAQO6oI6dXm5NgW6yW2FD-yO28G0gI8RoX9oQjl50WnlNTnLZqTFcq-mGLVSX1nWsyanYGeE0b5iYdPGn4Wkg_-cY3Cwz1BJcExgZynNjKLKwq0vMX0FOSAwutlRVHb2FnCyoK8ki-6XpY8K7ePxDoLrysfqb2BDcPUUAx6soY"/>
</div>
<div class="absolute -bottom-6 -right-6 w-32 h-32 border-b-8 border-r-8 border-[#FBBF24]"></div>
</div>
</section>
...
<section class="py-24 px-8 md:px-24 bg-primary-container overflow-hidden relative">
...
<div class="text-primary-container font-black uppercase tracking-widest text-lg">Pune Automotive Hub</div>
</div>
</div>
</div>
</section>
...
<!-- Directors Section -->
<section class="py-16 px-8 md:px-24 bg-surface-container-low">
